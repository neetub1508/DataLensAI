            ...
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  {user.roles && (Array.isArray(user.roles) ? user.roles.length > 0 : Object.keys(user.roles).length > 0) && (
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-4">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                        <p>You don't have permission to access user management. Only administrators can manage users.</p>
                      </div>
                    </div>
                  </div>
                </div>
                                  ...
                                  <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                      ...
                                      <div className="text-sm text-gray-500 dark:text-gray-400">
                                        {Array.isArray(userItem.roles) ? userItem.roles.join(', ') : Object.values(userItem.roles as Record<string, string>).join(', ')}
                                      </div>
                                    </div>
                                  </div>
                                </td>
